...
class FlipbookFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_flipbook, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment FlipbookFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FlipbookFragment().apply {
